...
namespace _180316014_Doguhan_Ay
{
    public partial class Form1 : Form
    {
        ...
        {
            timerSayac--;
            Oyuncu1KalanZaman.Text = timerSayac.ToString();
            if (timerSayac == 0)
            {
                timer.Enabled = false;
        ...
        void ReceiveData(IAsyncResult iar)
        {
            ...
            if (receivedData.Substring(0, 2).Equals("PM"))
            {
                String gonderenIsmi = receivedData.Substring(2, 8);
                String gelenMesaj2 = receivedData.Substring(10);
            ...
            else if (receivedData.Substring(0, 4).Equals("TIME"))
            {
                String rakipSuresiBitti = receivedData.Substring(4);
            ...
            else if (receivedData.Substring(0, 6).Equals("SAHMAT"))
            {
                String bir = receivedData.Substring(6, 2);
                String iki = receivedData.Substring(8, 2);
                String rakibinZamani = receivedData.Substring(10);
                Oyuncu2KalanZaman.Text = rakibinZamani;
                switch (bir)
                {
                    case "A1":
                        geciciBoxDegeri = H8;
                ...
                DialogResult result1 = MessageBox.Show(" Player_2 Oyunu kazandı", "ŞAH MAT KAYBETTİN", MessageBoxButtons.OK);
                if (result1 == DialogResult.OK)
                {
                    this.Close();
                }
            ...
            {
                String bir = receivedData.Substring(0, 2);
                String iki = receivedData.Substring(2, 2);
                String rakibinZamani = receivedData.Substring(4);
                Oyuncu2KalanZaman.Text = rakibinZamani;
                switch (bir)
                {
                    case "A1":
        ...
        {
            string stringData = "PM" + "PLAYER_1" + textBox1.Text;
            message11 = Encoding.ASCII.GetBytes(stringData);
            string[] row = { "PLAYER_1", textBox1.Text };
            var satir = new ListViewItem(row);
            listView1.Items.Add(satir);
            textBox1.Text = "";
            client.BeginSend(message11, 0, message11.Length, SocketFlags.None, new AsyncCallback(SendData), client);
        ...
        {
            var array1 = converterDemo(Properties.Resources.piyonBeyaz);
            var array2 = converterDemo(Properties.Resources.vezirBeyaz);
            var array3 = converterDemo(Properties.Resources.sahBeyaz);
            var array4 = converterDemo(Properties.Resources.kaleByeaz);
            var array5 = converterDemo(Properties.Resources.filBeyaz);
            var array6 = converterDemo(Properties.Resources.atBeyaz);
            var array7 = converterDemo(Properties.Resources.sahSiyah);
            ...
            else if (sayac == 1)
            {
                if (isSame1 != true && isSame2 != true && isSame3 != true && isSame4 != true && isSame5 != true && isSame6 != true)
                {
                    ...
                    else
                    {
                        ...
                        geciciBoxDegeri.Image = null;
                        sayac = 0;
                        string stringData = geciciBoxDegeriString + hedefBoxDegeriString + timerSayac.ToString();
